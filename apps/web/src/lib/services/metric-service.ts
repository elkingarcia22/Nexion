...
export async function seedMetricsFromPdf(
  ...
  const metrics: Omit<Metric, "id" | "created_at" | "updated_at">[] = [
    ...
    { workspace_id: workspaceId, name: "ARR Contratación", category: "contratacion", current_value: 8200, unit: "USD", source: "pdf_seed", sort_order: 10, metadata: {} },
    { workspace_id: workspaceId, name: "ARR NSM Contratación", category: "contratacion", current_value: 1300, unit: "USD", source: "pdf_seed", sort_order: 11, metadata: {} },
