...
export async function seedMetricsFromPdf(
  ...
  const metrics: Omit<Metric, "id" | "created_at" | "updated_at">[] = [
    ...
    { workspace_id: workspaceId, name: "ARR Matriz de Talento", category: "matriz_talento", current_value: 43100, unit: "USD", source: "pdf_seed", sort_order: 6, metadata: {} },
    { workspace_id: workspaceId, name: "ARR NSM Matriz de Talento", category: "matriz_talento", current_value: 3300, unit: "USD", source: "pdf_seed", sort_order: 7, metadata: {} },
    { workspace_id: workspaceId, name: "ARR Evaluación 360", category: "evaluacion_360", current_value: 127600, unit: "USD", source: "pdf_seed", sort_order: 8, metadata: {} },
    { workspace_id: workspaceId, name: "ARR NSM Evaluación 360", category: "evaluacion_360", current_value: 48300, unit: "USD", source: "pdf_seed", sort_order: 9, metadata: {} },
    { workspace_id: workspaceId, name: "ARR Reclutamiento", category: "reclutamiento", current_value: 8200, unit: "USD", source: "pdf_seed", sort_order: 10, metadata: {} },
    { workspace_id: workspaceId, name: "ARR NSM Reclutamiento", category: "reclutamiento", current_value: 1300, unit: "USD", source: "pdf_seed", sort_order: 11, metadata: {} },
    ...
    { workspace_id: workspaceId, name: "ARR LMS Creator", category: "lms_creator", current_value: 14000, unit: "USD", source: "pdf_seed", sort_order: 16, metadata: {} },
    { workspace_id: workspaceId, name: "ARR NSM LMS Creator", category: "lms_creator", current_value: 3000, unit: "USD", source: "pdf_seed", sort_order: 17, metadata: {} },
