...
const days = [
  {
    ...
    kpi_data: {
      ...
      insights: [
        ...
        { title: 'Tiempo de contratación se reduce con el nuevo flujo', description: 'El tiempo promedio para cubrir una vacante bajó de 18 a 12 días hábiles.', category: 'hiring', product: 'contratacion', responsible: null, goal_id: pickObj('hiring'), linked_jira_key: null },
      ],
      alerts: [
  ...
  },
  {
    ...
    kpi_data: {
      tasks: [
        ...
        { title: 'Revisar y optimizar flujo de entrevistas', description: 'Simplificar el proceso de agendamiento de entrevistas basado en feedback de reclutadores.', priority: 'medium', category: 'hiring', product: 'contratacion', responsible: 'Elkin Garcia', due_date: fmt(new Date(today.getTime() + 10*86400000)), goal_id: pickObj('hiring'), linked_jira_key: null, linked_metric_names: [], team: 'hiring', metadata: { auto_generated: true } },
      ],
      insights: [
        ...
        { title: 'Nueva vista de candidatos reduce tiempo de revisión', description: 'La vista con pipeline visual permite a los reclutadores revisar candidatos 2x más rápido.', category: 'hiring', product: 'contratacion', responsible: null, goal_id: pickObj('hiring'), linked_jira_key: null },
      ],
      alerts: [
        { title: '3 vacantes críticas sin candidatos preseleccionados', description: 'Las posiciones de Senior Backend, PM y Diseñador UX no tienen candidatos en etapa de entrevista.', priority: 'critica', category: 'Hiring', product: 'contratacion', responsible: null, goal_id: null, linked_jira_key: null },
      ...
      feedback: [
        { title: 'Mejora en proceso de entrevistas', description: 'Los candidatos reportan una mejor experiencia con el nuevo formato de entrevista estructurada.', type: 'producto', category: 'hiring', product: 'contratacion', responsible: null, goal_id: null },
